...
import special_player from "../Game5Object/special_player";

const {ccclass, property} = cc._decorator;

@ccclass
export default class TransGround_special extends cc.Component {
    ...
    start () {
        this.playerSpeed = cc.find('Canvas/PlayerContainer/player1').getComponent(special_player).playerSpeed;
    ...
    onBeginContact(contact, self, other){
        ...
        if(other.node.group == 'player'){
            ...
            let p = other.node.getComponent(special_player);
